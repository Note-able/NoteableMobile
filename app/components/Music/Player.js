      ...
      <View style={{ flexDirection: 'column', flex: 0, height: 60 }}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.playControls}>
            <TouchableHighlight>
              <Image style={styles.secondaryIcon} source={require('../../img/rewind.png')} />
            </TouchableHighlight>
            <TouchableHighlight
              onPress={() => {
            ...
            >
              <Image source={this.state.isPlaying ? require('../../img/pause.png') : require('../../img/play.png')} style={styles.primaryIcon} />
            </TouchableHighlight>
            <TouchableHighlight>
              <Image style={styles.secondaryIcon} source={require('../../img/fast_forward.png')} />
            </TouchableHighlight>
          </View>
        </View>
      </View>);
