      ...
      <View style={styles.modalContainer}>
        <View style={styles.modal}>
          ...
          <TextInput
            ...
            onChangeText={name => this.setState({ fileName: name })}
            value={this.state.fileName}
            underlineColorAndroid="transparent"
          />
          <Text style={styles.inputLabel}>Tags</Text>
          <Text style={[styles.inputLabel, { fontSize: 10 }]}>(comma separated)</Text>
          <TextInput
            style={styles.inputField}
          ...
          <View style={styles.buttonRow}>
            <TouchableHighlight style={styles.buttonOption} onPress={this.props.cancel}>
              <Text style={{ textAlign: 'center', color: '#95989A', fontSize: 16 }}>
