...
export const startPlayer = recording => async (dispatch, getState) => {
  ...
  const reactNativeSound = new Sound(
    recording.path !== '' ? realPath : recording.audioUrl,
    '',
    error => {
      if (error) {
